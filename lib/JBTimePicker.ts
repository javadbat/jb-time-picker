...
import { AnimationHandler, DefaultPositions, GrabbedElement, JBTimeInputElements, JBTimePickerValueObject, TimeUnitsObject, TimeUnitsString } from './Types';
    ...
    */
    ...
    set value(value: JBTimePickerValueObject) {
        if (!this.animationHandler.hour.isTextAnimationPlaying) {
            ...
            this.animationHandler.hour.waitingAction = () => { this.updateValue(value.hour, TimeUnits.hour, false); };
        }
    ...
    initTimeTextNodes() {
        ...
        if (this.secondEnabled && currentSecond + 1 < this.maxTimeUnitValues.second) {
    ...
    attachMouseDownEventToTimeTextDOM(timeUnit, timeStep) {
        ...
        if (element) {
            ...
            if (typeof prevBindedEvent == "function") {
                ...
                element.removeEventListener('touchstart', element._bindedTouchStartEvent);
            }
            //bind new event
            const mouseDownEventFunc = (e) => { this.onTextMouseDown(e, timeUnit, timeStep); };
            const touchStartEventFunc = (e) => { this.onTextTouchStart(e, timeUnit, timeStep); };
    ...
    initProp() {
        ...
        */
        ...
        this.defaultPositions = {
            ...
            get svgPosScale() { return 1; }//define orginal func down there
        };
    ...
    handleTextClick(timeUnit: TimeUnitsString, timeStep: string) {
    ...
    subtrackTimeTextUnitDomOperation(timeUnit: TimeUnitsString, svgYDiff: number) {
    ...
    createTimeTextDOM(timeUnit: TimeUnitsString, timeStep: string, timeValue: number) {
        ...
        const add1ToValue = () => {
            ...
            const onFinish = () => {
                if (!isOnFinishedExecuted) {
                    ...
                    if (typeof this.animationHandler[timeUnit].waitingAction === "function") {
